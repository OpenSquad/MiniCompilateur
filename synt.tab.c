...
static const yytype_uint8 yyprhs[] =
{
     ...
     130,   140,   147,   151,   155,   159,   163,   167,   171,   175,
     180,   185,   189,   193,   197,   199,   201,   203,   205,   207
};
...
static const yytype_int8 yyrhs[] =
{
      ...
      18,    36,    -1,    21,    -1,    41,    37,    -1,    38,    37,
      -1,    39,    37,    -1,    41,    -1,    38,    -1,    39,    -1,
      10,    21,    15,    21,    11,    21,    12,    37,    13,    -1,
      10,    21,    15,    43,    11,    43,    12,    37,    13,    -1,
      10,    43,    15,    43,    11,    43,    12,    37,    13,    -1,
      10,    43,    15,    21,    11,    43,    12,    37,    13,    -1,
      12,    41,    14,    19,    40,    20,    -1,    21,    16,    22,
      -1,    21,    16,    23,    -1,    22,    16,    22,    -1,    22,
      16,    23,    -1,    23,    16,    22,    -1,    23,    16,    23,
      -1,    21,    16,    21,    -1,    21,    15,    42,    26,    -1,
      21,    15,    24,    26,    -1,    42,    17,    21,    -1,    42,
      17,    23,    -1,    42,    17,    22,    -1,    21,    -1,    23,
...
static const yytype_uint8 yyrline[] =
{
      ...
      78,    82,    88,    90,    91,    92,    93,    94,    95,   102,
     104,   107,   109,   111,   113,   114,   115,   119,   120,   121
};
#endif
...
/* Line 1455 of yacc.c  */
#line 88 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(3) - (3)].entier));sprintf(tmp3,"Q%d",jump);
quadr((yyvsp[(2) - (3)].chaine),tmp3,(yyvsp[(1) - (3)].chaine),tmp);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 90 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(3) - (3)].reel) );sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,(yyvsp[(1) - (3)].chaine),tmp);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 91 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(1) - (3)].entier));sprintf(tmp2,"%d",(yyvsp[(3) - (3)].entier));sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,tmp2,tmp);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 92 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(1) - (3)].entier));sprintf(tmp2,"%d",(yyvsp[(3) - (3)].reel));sprintf(tmp4,"%d",t+1);sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,tmp,tmp4);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 93 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(1) - (3)].reel));sprintf(tmp2,"%d",(yyvsp[(3) - (3)].entier));sprintf(tmp2,"%d",(yyvsp[(3) - (3)].entier));sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,tmp2,tmp);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 94 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(1) - (3)].reel));sprintf(tmp2,"%d",(yyvsp[(3) - (3)].reel));sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,tmp,tmp2);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 95 "synt.y"
    {t=t+1;sprintf(tmp,"%d",(yyvsp[(3) - (3)].chaine));sprintf(tmp3,"Q%d",jump);quadr((yyvsp[(2) - (3)].chaine),tmp3,(yyvsp[(1) - (3)].chaine),tmp);;}
    break;
...
/* Line 1455 of yacc.c  */
#line 102 "synt.y"
    {if(strcmp(ts[recherche((yyvsp[(1) - (4)].chaine))].TypeEntite,type)!=0 && (strcmp(ts[recherche((yyvsp[(1) - (4)].chaine))].TypeEntite,"reel")==0 && strcmp(type,"entier")==0)) {printf("-----------Erreur de type d'affectation ! LIGNE : %d . La variable: %s declare commme %s  \n ",nb_ligne,(yyvsp[(1) - (4)].chaine),ts[recherche((yyvsp[(1) - (4)].chaine))].TypeEntite);}
			else {jump=qc;quadr(":=",tmp2,"  ",(yyvsp[(1) - (4)].chaine));} ;}
    break;
...
/* Line 1455 of yacc.c  */
#line 104 "synt.y"
    {if(strcmp(ts[recherche((yyvsp[(1) - (4)].chaine))].TypeEntite,"chaine")!=0) {printf("-----------Erreur de type d'affectation ! LIGNE : %d . La variable: %s declare commme %s  \n ",nb_ligne,(yyvsp[(1) - (4)].chaine),ts[recherche((yyvsp[(1) - (4)].chaine))].TypeEntite);}
			else {strcpy(type,"chaine");strcpy(tmp2,(yyvsp[(3) - (4)].chaine));jump=qc;quadr(":=",tmp2," ",(yyvsp[(1) - (4)].chaine));};}
    break;
...
#line 107 "synt.y"
    { if( (yyvsp[(3) - (3)].chaine)==0 && strcmp("/",(yyvsp[(2) - (3)].chaine))==0) {printf("ERREUR SEMANTIQUE : division par zero ligne %d colonne %d \n ",nb_ligne,nb_colonne-1);} 
			else {sprintf(tmp,"T%d",t);sprintf(tmp2,"T%d",t+1);quadr((yyvsp[(2) - (3)].chaine),tmp,(yyvsp[(3) - (3)].chaine),tmp2);sprintf(tmp2,"T%d",t+1);t=t+1;};}
    break;
...
#line 109 "synt.y"
    { if((yyvsp[(3) - (3)].reel)==0 && strcmp("/",(yyvsp[(2) - (3)].chaine))==0){printf(" ERREUR SEMANTIQUE: division par zero ligne %d colonne %d \n ",nb_ligne,nb_colonne-1);}
            else{sprintf(tmp,"%.2f",(yyvsp[(3) - (3)].reel));sprintf(tmp3,"T%d",t);sprintf(tmp4,"T%d",t+1);quadr((yyvsp[(2) - (3)].chaine),tmp2,tmp,tmp4);sprintf(tmp2,"T%d",t+1);t=t+1; };}
    break;
...
#line 111 "synt.y"
    { if ( (yyvsp[(3) - (3)].entier)==0 && strcmp("/",(yyvsp[(2) - (3)].chaine))==0) {printf(" ERREUR SEMANTIQUE: division par zero ligne %d colonne %d \n ",nb_ligne,nb_colonne-1);}
		    else { sprintf(tmp,"%d",(yyvsp[(3) - (3)].entier));sprintf(tmp3,"T%d",t);sprintf(tmp4,"T%d",t+1);quadr((yyvsp[(2) - (3)].chaine),tmp2,tmp,tmp4);sprintf(tmp2,"T%d",t+1);t=t+1;};}
    break;
...
/* Line 1455 of yacc.c  */
#line 113 "synt.y"
    {strcpy(type,ts[recherche((yyvsp[(1) - (1)].chaine))].TypeEntite);strcpy(tmp2,(yyvsp[(1) - (1)].chaine));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 114 "synt.y"
    {strcpy(type,"reel");sprintf(tmp2,"%.2f",(yyvsp[(1) - (1)].reel));;}
    break;
...
/* Line 1455 of yacc.c  */
#line 115 "synt.y"
    {strcpy(type,"entier");sprintf(tmp2,"%d",(yyvsp[(1) - (1)].entier));;}
    break;
